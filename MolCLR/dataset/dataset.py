...
#         self.smiles_data = self.smiles_data
...
#     def __getitem__(self, index):
#         smiles_list = self.smiles_data[
#             index
#         ]  # Assuming this is a list of SMILES strings
#         # data_list = []
...
#                 print(f"Could not parse SMILES string: {smiles_list}")
...
#             print(f"Error processing SMILES string: {smiles_list}. Error: {e}")

#         # Depending on how you want to handle multiple graphs, you might return a list of Data objects or a single batched Data object
#         return original_data  # Or use torch_geometric.data.Batch.from_dat
#         mol = Chem.MolFromSmiles(self.smiles_data[index])
