...
# assigns learning rate to optimizer
def assign_learning_rate(optimizer, new_lr):
    for param_group in optimizer.param_groups:
        param_group["lr"] = new_lr


# The warmup learning rate gradually increases from a small value to
# the baseline learning rate over a specified number of steps.
